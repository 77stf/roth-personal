...
const INTEGRATIONS: Integration[] = [
  ...
  },
  {
    ...
    icon: '📊',
    name: 'Google Sheets',
    tagline: 'Baza danych · 26 arkuszy',
    color: '#0f9d58',
    statusKey: 'GOOGLE_REFRESH_TOKEN',
    what: 'Google Sheets to główna baza danych systemu. 26 arkuszy przechowuje wszystko — od planu lekcji po finanse, OFM, streaki i system log.',
    capabilities: [
      'Plan lekcji + zastępstwa + rozkład busów',
      'Tracker finansów (przychody, wydatki, budżet, cele)',
      'Projekty OFM i AI Consulting + Osoby Profile',
      'Logi treningów, prania, sprzątania, diety',
      'STREAKI, WATER_TRACKER, SYSTEM_LOG, ZADANIA_DNIA',
    ],
    cheatsheet: [
      { label: 'Read sheet', value: 'GET /api/sheets/[SHEET_NAME]' },
      { label: 'Write row', value: 'POST /api/sheets/[SHEET_NAME]' },
      { label: 'Arkusze', value: '26 arkuszy (PLAN_LEKCJI, FINANSE_*, PROJEKTY_*, STREAKI, ...)' },
  ...
  },
  {
    ...
    what: 'Telegram Bot — 20 komend w 5 kategoriach. Tekst bez / → Master Agent (Claude). Briefy morning/evening/sleep automatyczne przez Make.com i GitHub Actions.',
    capabilities: [
      'Szkoła: /kartkowka /sprawdzian /kolo /praca [przedmiot] [termin]',
      'Transport: /wsiadam /dotarlem /kolega_odwola',
      'Sport: /koniec_silownia /opuscil_trening /choruje /streak [nawyk]',
      'Daily: /brief /ofm /pomo /tasks /posprzatane /przedluzam',
      'System: /pause_briefs /resume_briefs · tekst → Master Agent',
    ],
    cheatsheet: [
      { label: 'Webhook', value: 'POST /api/telegram/webhook' },
      { label: 'Komendy', value: '20 komend (Grammy framework, webhook mode)' },
      { label: 'Briefy auto', value: 'Morning 07:00 (Make) · Evening 20:00 (Make) · Sleep 23:00 (GitHub)' },
      { label: 'Cooldown /brief', value: '30 min (przechowywane w USTAWIENIA Sheets)' },
    ],
  },
  {
    id: 'obsidian',
